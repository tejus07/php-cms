...
<main>
    <div class="container">
        ...
        <ul class="details-list">
            <li class="detail-item">Preparation Time:
                <?php echo $recipe['preparation_time']; ?> minutes
            </li>
            <li class="detail-item">Cooking Time:
                <?php echo $recipe['cooking_time']; ?> minutes
            </li>
            <li class="detail-item">Servings:
                <?php echo $recipe['servings']; ?>
            </li>
            <li class="detail-item">Difficulty Level:
                <?php echo $recipe['difficulty_level']; ?>
            </li>
            <li class="detail-item">Cuisine:
                <?php echo $recipe['cuisine']; ?>
            </li>
            <li class="detail-item">Course:
                <?php echo $recipe['course']; ?>
            </li>
        </ul>
